      ...
      <section className="py-5 pb-12 text-black relative ">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-primary font-semibold mt-2 text-xl drop-shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Card 1 */}
            <div className="group bg-bg-gray  backdrop-blur-xl border border-blue-200 rounded-2xl p-8 hover:border-blue-400 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-300/30">
