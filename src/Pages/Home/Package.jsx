  ...
  return (
    <section className="py-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 p-10">
          {/* Starter */}
          <div className="border border-blue-600/20 rounded-3xl p-8 hover:border-blue-800 transition-all hover:shadow-2xl hover:shadow-blue-200/30">
            ...
            <Link
              ...
              className="w-full block text-center bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 py-4 rounded-full font-bold transition text-white"
            >
              Get Started
            </Link>
          </div>
          ...
          {/* Professional */}
          <div className="relative border border-blue-800 rounded-3xl p-8 transform hover:scale-105 transition-all shadow-sm hover:shadow-2xl hover:shadow-blue-200/30">
